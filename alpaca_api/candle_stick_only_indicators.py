...
def append_indicators(df_raw):
    ...
    df_raw.ta.macd(append=True) # very inefficient compared to pandas_ta indicators;

    df_raw.ta.cdl_pattern("all", append=True, scalar = 1) # very inefficient compared to pandas_ta indicators;
...
def main():
    ...
    for name, df in groups:
        ...
        df.to_csv(f'data/csv/cdl_test.csv', index=True, index_label=['symbol', 'timestamp'])
