...
with open('lists_no_multithread_AAPL.pkl', 'rb') as f:
...
# df = pd.concat([df, tmp])
# print(df)
df_sorted = tmp.sort_values('account_growth')
print(df_sorted)


tmp.to_csv('../data/feature_efficacy_test_AAPL_FULL.csv', index=False)